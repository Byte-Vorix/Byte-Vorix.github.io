	...
	<menu
		...
		<Transition>
			<ul class="grid md:flex gap-8 justify-center justify-items-center rounded-t-lg md:justify-between items-center px-2 fixed md:relative bottom-0 bg-[color:hsl(0,0%,95%)] dark:bg-[color:hsl(0,0%,5%)]  backdrop-blur-2xl md:bg-transparent md:dark:bg-transparent right-0 w-full md:w-fit grid-cols-2 py-4 md:py-0 z-20"
				v-if="menu.mmenu">
				<li><a @click="scrolldown('home')" class="cursor-pointer transition-colors hover:text-blue-600 dark:hover:text-green-400">{{ $t('home')
				}}</a></li>
				<li><a @click="scrolldown('services')" class="cursor-pointer transition-colors hover:text-blue-600 dark:hover:text-green-400">{{
					$t('services')
				}}</a></li>
				<li><a @click="scrolldown('team')" class="cursor-pointer transition-colors hover:text-blue-600 dark:hover:text-green-400">{{ $t('team')
				}}</a></li>
				<li><a @click="scrolldown('contact')" class="cursor-pointer transition-colors hover:text-blue-600 dark:hover:text-green-400">{{ $t('contact')
				}}</a></li>
